...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './enclos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENCLOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENCLOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENCLOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENCLOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENCLOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENCLOS actions', async () => {
      const expectedActions = [
        {

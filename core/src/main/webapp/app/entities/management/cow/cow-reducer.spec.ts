...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cow.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COW_LIST actions', async () => {
    ...
    it('dispatches FETCH_COW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COW actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './groups.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPS actions', async () => {
      const expectedActions = [
        {

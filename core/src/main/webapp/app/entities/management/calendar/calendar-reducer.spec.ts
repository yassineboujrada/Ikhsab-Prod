...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './calendar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALENDAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALENDAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALENDAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALENDAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALENDAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALENDAR actions', async () => {
      const expectedActions = [
        {

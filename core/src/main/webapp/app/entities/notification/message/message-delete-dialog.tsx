...
export const MessageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.notificationMessage.delete.question">
        <Translate contentKey="coreApp.notificationMessage.delete.question" interpolate={{ id: messageEntity.id }}>

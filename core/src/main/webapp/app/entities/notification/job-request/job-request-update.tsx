  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="coreApp.notificationJobRequest.home.createOrEditLabel" data-cy="JobRequestCreateUpdateHeading">
            <Translate contentKey="coreApp.notificationJobRequest.home.createOrEditLabel">Create or edit a JobRequest</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('coreApp.notificationJobRequest.consumer')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationJobRequest.provider')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationJobRequest.serviceStatus')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationJobRequest.roomId')}

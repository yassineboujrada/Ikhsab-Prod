    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobRequestDetailsHeading">
          <Translate contentKey="coreApp.notificationJobRequest.detail.title">JobRequest</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="consumer">
              <Translate contentKey="coreApp.notificationJobRequest.consumer">Consumer</Translate>
            </span>
          </dt>
          <dd>{jobRequestEntity.consumer}</dd>
          <dt>
            <span id="provider">
              <Translate contentKey="coreApp.notificationJobRequest.provider">Provider</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="roomId">
              <Translate contentKey="coreApp.notificationJobRequest.roomId">Room Id</Translate>
            </span>
          </dt>

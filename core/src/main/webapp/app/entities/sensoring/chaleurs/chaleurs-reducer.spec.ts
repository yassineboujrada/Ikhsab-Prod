...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './chaleurs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHALEURS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHALEURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHALEURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHALEURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHALEURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHALEURS actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sante.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SANTE actions', async () => {
      const expectedActions = [
        {

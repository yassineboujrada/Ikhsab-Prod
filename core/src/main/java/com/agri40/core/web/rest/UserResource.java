...
import com.agri40.core.config.Constants;
...
import com.agri40.core.web.rest.errors.EmailAlreadyUsedException;
import com.agri40.core.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link com.agri40.core.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    // update user profile  - only for the current user and if the id is the same as the current user get user from the provided token

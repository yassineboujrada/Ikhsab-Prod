...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.agri40.core.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.agri40.core.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
